...
pub fn get_signed_block(priv_k: &[u8; 32], rep: &[u8; 32], previous: &[u8; 32], link: &[u8; 32], balance: u128, block_hash: &[u8; 32]) -> Block {
        ...
        let internal_signed = expanded_secret.sign(block_hash, &ed25519_dalek::PublicKey::from(&secret));
...
pub fn validate_mnemonic(mnemonic: String) -> ([u8; 32], bool) {
        let mnemonic = get_num_equivalent(mnemonic);
...
pub fn get_num_equivalent(mnemonic: String) -> [u16; 24] {
